...
if (data === '03/03') {
  ...
  <li><span class="horario">19:40</span> <span class="label-dub">DUB</span> <span class="class-14">14</span> <span class="filme">MODERN FAMILY - E10 - T02</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:00</span> <span class="label-dub">DUB</span> <span class="class-16">16</span> <span class="filme">STRIP LAW - E05 - T01</span></li> <hr class="filme-separador"> 
  <li><span class="horario">20:30</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">MISTÉRIO DE UM MILHÃO DE SEGUIDORES - E08 - T01</span></li> <hr class="filme-separador">      
  `;
}
else if (data === '04/03') {
  programacaoDiv.innerHTML = `
