...
if (data === '27/02') {
  ...
  <li class="filme-container"> <div class="filme-info"> <span class="horario">23:59</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <img src="imgs//dts.png" alt="Logo DTS" class="logo-dts"> <span class="filme">SÃO PAULO SOCIEDADE ANÔNIMA</span> </div> </li> <hr class="filme-separador"> </li>  
  `;
}
else if (data === '03/03') {
  programacaoDiv.innerHTML = `
