...
if (data === '16/01') {
  ...
  <li><span class="horario">21:05</span> <span class="label-leg">LEG</span> <span class="class-10">10</span> <span class="filme">STAR WARS: SKELETON CREW - E08 - T01</span></li> <hr class="filme-separador">    
`;
}
else if (data === '17/01') {
  programacaoDiv.innerHTML = `
