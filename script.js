...
if (data === '11/04') {
  ...
  <ul>  
  <li <class="filme-container"> <div class="filme-info"> <span class="horario">00:00</span> <span class="label-leg">LEG</span> <span class="class-18">18</span> <img src="imgs//dts.png" alt="Logo DTS" class="logo-dts"> <span class="filme">BLACK MIRROR - E01 - T07</span> </div> </li> <hr class="filme-separador"> </li>
  <li><span class="horario">11:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">    
  <li><span class="horario">13:25</span> <span class="label-orig">DUB</span> <span class="class-12">12</span> <span class="filme">HOW I MET YOUR MOTHER - E15 - T01</span></li> <hr class="filme-separador">    
 `;
}
else if (data === '14/04') {
  programacaoDiv.innerHTML = `
...
`;
  ...
  <li><span class="horario">11:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">    
  <li><span class="horario">13:25</span> <span class="label-orig">DUB</span> <span class="class-12">12</span> <span class="filme">HOW I MET YOUR MOTHER - E18 - T01</span></li> <hr class="filme-separador">    
 `;
}
else if (data === '18/04') {
  programacaoDiv.innerHTML = `
  ...
  <li><span class="horario">11:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">    
  <li><span class="horario">19:10</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP2</span></li> <hr class="filme-separador"> 
  <li><span class="horario">19:40</span> <span class="label-orig">DUB</span> <span class="class-12">12</span> <span class="filme">HOW I MET YOUR MOTHER - E19 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:00</span> <span class="label-leg">LEG</span> <span class="class-16">16</span> <span class="filme">COMO VENDER DROGAS ONLINE (RÁPIDO) - E04 - T04</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:40</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">O JARDINEIRO - E03 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">21:30</span> <span class="label-leg">LEG</span> <span class="class-16">16</span> <span class="filme">O DOMO DE VIDRO - E02 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">22:20</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">NOS BASTIDORES DE STRANGER THINGS: A PRIMEIRA SOMBRA</span></li> <hr class="filme-separador">    
`;
}
else if (data === '19/04') {
  programacaoDiv.innerHTML = `
  ...
  <li><span class="horario">20:10</span> <span class="label-orig">DUB</span> <span class="class-12">12</span> <span class="filme">HOW I MET YOUR MOTHER - E21 - T01</span></li> <hr class="filme-separador">    
  ...
  <li><span class="horario">23:00</span> <span class="label-leg">LEG</span> <span class="class-16">16</span> <span class="filme">THE LAST OF US - E02 - T02</span></li> <hr class="filme-separador">    
 `;
}
else if (data === '21/04') {
  programacaoDiv.innerHTML = `
  <ul>  
  <li <class="filme-container"> <div class="filme-info"> <span class="horario">00:00</span> <span class="label-leg">LEG</span> <span class="class-18">18</span> <img src="imgs//dts.png" alt="Logo DTS" class="logo-dts"> <span class="filme">BLACK MIRROR - E05 - T07</span> </div> </li> <hr class="filme-separador"> </li>
  <li><span class="horario">11:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">    
...
// confirmar ep de o jardineiro e o domo de vidro PARA LANÇAR 23/04 E 24/04
  ...
  <li><span class="horario">19:15</span> <span class="label-orig">DUB</span> <span class="class-12">12</span> <span class="filme">HOW I MET YOUR MOTHER - E01 - T02</span></li> <hr class="filme-separador">    
  <li><span class="horario">19:35</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">O JARDINEIRO - E06 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:30</span> <span class="label-leg">LEG</span> <span class="class-16">16</span> <span class="filme">O DOMO DE VIDRO - E05 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">21:30</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">CONMEBOL LIBERTADORES</span></li> <hr class="filme-separador"> 
`;
}
else if (data === '24/04') {
  programacaoDiv.innerHTML = `
  <ul>  
  <li <class="filme-container"> <div class="filme-info"> <span class="horario">00:00</span> <span class="label-leg">LEG</span> <span class="class-18">18</span> <img src="imgs//dts.png" alt="Logo DTS" class="logo-dts"> <span class="filme">BLACK MIRROR - E06 - T07</span> </div> </li> <hr class="filme-separador"> </li>
  <li><span class="horario">11:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">    
  <li><span class="horario">19:10</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP2</span></li> <hr class="filme-separador"> 
...
<span class="filme">NOS BASTIDORES DE STRANGER THINGS: A PRIMEIRA SOMBRA</span>
<div class="filme-texto">
...
<li class="filme-poster">
<img src="imgs//poster-shadow.jpg" alt="STRANGER THINGS: A PRIMEIRA SOMBRA - BROADWAY">
<div class="filme-texto">
<span class="dia">22/04</span>
<span class="class-14">14</span>
<span class="filme">STRANGER THINGS: A PRIMEIRA SOMBRA - BROADWAY</span>
<div class="filme-texto">
<span class="class-documentario">Documentário</span>
</div>
</li>
...
<li class="filme-poster">
<img src="imgs//poster-congonhas.jpg" alt="CONGONHAS: TRAGÉDIA ANUNCIADA">
<div class="filme-texto">
<span class="dia">24/04</span>
<span class="class-14">14</span>
<span class="filme">CONGONHAS: TRAGÉDIA ANUNCIADA</span>
<div class="filme-texto">
<span class="class-documentario">Documentário</span>
</div>
</li>
