...
if (data === '06/01') {
  ...
  <li><span class="horario">23:00</span> <span class="label-leg">LEG</span> <span class="class-10">10</span> <span class="filme">STAR WARS: SKELETON CREW - E07 - T01</span></li> <hr class="filme-separador">    
  `;
}
else if (data === '08/01') {
  programacaoDiv.innerHTML = `
...
`;
  ...
  <li><span class="horario">20:05</span> <span class="label-leg">LEG</span> <span class="class-18">18</span> <span class="filme">ROUND 6 - E08 - T02</span></li> <hr class="filme-separador">    
  <li><span class="horario">21:05</span> <span class="label-leg">LEG</span> <span class="class-18">18</span> <span class="filme">TERRA INDOMÁVEL - E01 - T01</span></li> <hr class="filme-separador">    
`;
}
