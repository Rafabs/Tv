function mostrarProgramacao(button, data) {
  ...
  if (data === '02/08') {
    programacaoDiv.innerHTML = `
      <ul>
        ...
        <li><span class="horario">12:00</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP1</span></li> <hr class="filme-separador">
  ...
  // Eliminar o primeiro item de Em Breve 
    ...
    `;
    // AGUARDANDO AMANDA DEFINIR FILME + ESTREIA THE WITCHER T3
  } else if (data === 'XX/08') {
    programacaoDiv.innerHTML = `
      <ul>
      </ul>
