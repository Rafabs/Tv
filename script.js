function mostrarProgramacao(button, data) {
 ...
 if (data === '21/09') {
  ...
  <li><span class="horario">13:45</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">AGATHA DESDE SEMPRE - E02 - T01</span></li> <hr class="filme-separador">    
  ...
  <li><span class="horario">15:05</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">MEIA-NOITE NO HOTEL PERA PALACE - E05 - T02</span></li> <hr class="filme-separador">    
...
`;
  ...
  <li><span class="horario">20:00</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">AGATHA DESDE SEMPRE - E03 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:40</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">MEIA-NOITE NO HOTEL PERA PALACE - E06 - T02</span></li> <hr class="filme-separador">    
  </ul>
`;
}
else if (data === '26/09') {
...
`;
  ...
  <li><span class="horario">20:00</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">AGATHA DESDE SEMPRE - E04 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">20:40</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">MEIA-NOITE NO HOTEL PERA PALACE - E08 - T02</span></li> <hr class="filme-separador">    
  </ul>
`;
}
else if (data === '05/10') {
...
`;
  ...
  <li><span class="horario">23:45</span> <span class="label-leg">LEG</span> <span class="class-14">14</span> <span class="filme">AGATHA DESDE SEMPRE - E05 - T01</span></li> <hr class="filme-separador">    
  </ul>
`;
}
else if (data === '10/10') {
