function mostrarProgramacao(button, data) {
 ...
 if (data === '04/12') {
  ...
  <li><span class="horario">18:45</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP2</span></li> <hr class="filme-separador">    
   <li><span class="horario">19:15</span> <span class="label-dub">DUB</span> <span class="class-12">12</span> <span class="filme">YOUNG SHELDON - E01 - T07</span></li> <hr class="filme-separador">    
  ...
  <li><span class="horario">22:30</span> <span class="label-orig">NAC</span> <span class="class-16">16</span> <span class="filme">SENNA - E04 - T01</span></li> <hr class="filme-separador">    
  <li><span class="horario">23:45</span> <span class="label-leg">LEG</span> <span class="class-12">12</span> <span class="filme">STAR WARS: SKELETON CREW - E01 - T01</span></li> <hr class="filme-separador">    
  </ul>
`;
}
else if (data === '05/12') {
