function mostrarProgramacao(button, data) {
 ...
 if (data === '09/09') {
  ...
  <li><span class="horario">13:25</span> <span class="label-dub">DUB</span> <span class="class-12">12</span> <span class="filme">YOUNG SHELDON - E01 - T04</span></li> <hr class="filme-separador">    
  </ul>
`;
}  
else if (data === '11/09') {
