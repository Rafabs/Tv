function mostrarProgramacao(button, data) {
 ...
 if (data === '21/09') {
  programacaoDiv.innerHTML = `
    ...
    <li><span class="horario">19:40</span> <span class="label-dub">DUB</span> <span class="class-12">12</span> <span class="filme">THE BIG BANG THEORY - E04-T4</span></li> <hr class="filme-separador">
  ...
  programacaoDiv.innerHTML = `
    ...
    <li><span class="horario">15:00</span> <span class="label-leg">LEG</span> <span class="class-0">0</span> <span class="filme">BLADE RUNNER</span></li> <hr class="filme-separador">    
    <li><span class="horario">19:10</span> <span class="label-orig">NAC</span> <span class="class-12">12</span> <span class="filme">SP2</span></li> <hr class="filme-separador">
    </ul>
  `;    
} else if (data === '24/09') {
  programacaoDiv.innerHTML = `
    ...
    <li><span class="horario">18:30</span> <span class="label-dub">DUB</span> <span class="class-12">12</span> <span class="filme">THE BIG BANG THEORY - E05-T4</span></li> <hr class="filme-separador">
    <li><span class="horario">18:50</span> <span class="label-leg">LEG</span> <span class="class-16">16</span> <span class="filme">SEX EDUCATION - E07-T4</span></li> <hr class="filme-separador">    
