...
if (data === '11/09') {
  ...
  <li><span class="horario">19:15</span> <span class="label-dub">DUB</span> <span class="class-14">14</span> <span class="filme">HOW I MET YOUR MOTHER - E09 - T06</span></li> <hr class="filme-separador">    
  `;
}
else if (data === '12/09') {
  programacaoDiv.innerHTML = `
