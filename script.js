function mostrarProgramacao(button, data) {
 ...
 if (data === '02/10') {
  programacaoDiv.innerHTML = `
    ...
    <li><span class="horario">20:00</span> <span class="label-dub">DUB</span> <span class="class-12">12</span> <span class="filme">MEGATUBARÃO 2</span></li> <hr class="filme-separador">
    </ul>
  `;                   
} else if (data === '03/10') {
  programacaoDiv.innerHTML = `
    ...
    <li><span class="horario">20:00</span> <span class="label-dub">DUB</span> <span class="class-16">16</span> <span class="filme">QUE HORAS EU TE PEGO?</span></li> <hr class="filme-separador">
    </ul>
  `; 
} else if (data === '04/10') {
  programacaoDiv.innerHTML = `
