...
`;
    ...
    programacaoDiv.innerHTML = `
    <ul>  
    <li><span class="horario">18:00</span> <span class="label-orig">NAC</span> <span class="class-16">16</span> <span class="filme">CIDADE DE DEUS</span></li> <hr class="filme-separador">    
