function exibirProgramacao() {
    ...
    var diasProgramacao = [                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
        ...
        },                                                                           
        {
            data: "2025-04-07",
            sessoes: [
                { horario: "23:59", titulo: "MUFASA: O REI LEÃO", poster: "poster-mufasa.jpg", detalhes: `<span class="label-leg">LEG</span> <span class="class-10">10</span>` },
                { horario: "11:45", titulo: "SP1", poster: "poster-sp1.jpg", detalhes: `<span class="label-orig">NAC</span> <span class="class-12">12</span>` },
                { horario: "13:25", titulo: "HOW I MET YOUR MOTHER", poster: "poster-himym.jpg", detalhes: `<span class="label-dub">DUB</span> <span class="class-12">12</span>` },
            ]
        }, 
        {
            ...
            sessoes: [
                ...
                { horario: "20:40", titulo: "ANDOR", poster: "poster-andor.jpg", detalhes: `<span class="label-leg">LEG</span> <span class="class-16">16</span>` },
                { horario: "21:30", titulo: "CONMEBOL LIBERTADORES", poster: "poster-conmebol-liberadores.jpg", detalhes: `<span class="label-orig">NAC</span> <span class="class-12">12</span>` },
            ]
        },    
        {
            data: "2025-04-11",
